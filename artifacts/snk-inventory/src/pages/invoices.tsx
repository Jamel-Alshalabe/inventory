  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={!!view} onOpenChange={(o) => !o && setView(null)}>
        <DialogContent className="max-w-2xl max-h-[90vh] p-0 overflow-hidden border-none bg-transparent" dir="rtl">
          {view && (
            <div className="bg-[#1a1c2c] rounded-2xl overflow-hidden shadow-2xl border border-slate-700/50">
              {/* Premium Header */}
